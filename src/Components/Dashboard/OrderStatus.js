          ...
          <Row className="g-sm-4 g-3 booking-status-main">
            <Col xxl="4" sm="6" className="booking-status-card">
              <Link className="booking-widget-card card" href={{ pathname: `/order`, query: { status: "pending" } }}>
                ...
                <Image height={26} width={26} src={"/assets/images/svg/box-time.svg"} className="img-fluid abs-icon" alt="medal-star" />
              </Link>
            </Col>
            <Col xxl="4" sm="6" className="booking-status-card">
              <Link className="booking-widget-card card" href={{ pathname: `/order`, query: { status: "processing" } }}>
                ...
                <Image height={26} width={26} src={"/assets/images/svg/note.svg"} className="img-fluid abs-icon" alt="note" />
              </Link>
            </Col>
            <Col xxl="4" sm="6" className="booking-status-card">
              <Link className="booking-widget-card card" href={{ pathname: `/order`, query: { status: "cancelled" } }}>
                ...
                <Image height={26} width={26} src={"/assets/images/svg/box-remove.svg"} className="img-fluid abs-icon" alt="Box1" />
              </Link>
            </Col>
            <Col xxl="4" sm="6" className="booking-status-card">
              <Link className="booking-widget-card card" href={{ pathname: `/order`, query: { status: "shipped" } }}>
                ...
                <Image height={26} width={26} src={"/assets/images/svg/box.svg"} className="img-fluid abs-icon" alt="Group" />
              </Link>
            </Col>
            <Col xxl="4" sm="6" className="booking-status-card">
              <Link className="booking-widget-card card" href={{ pathname: `/order`, query: { status: "out_for_delivery" } }}>
                ...
                <Image height={26} width={26} src={"/assets/images/svg/group.svg"} className="img-fluid abs-icon" alt="shop" />
              </Link>
            </Col>
            <Col xxl="4" sm="6" className="booking-status-card">
              <Link className="booking-widget-card card" href={{ pathname: `/order`, query: { status: "delivered" } }}>
                ...
                <Image height={26} width={26} src={"/assets/images/svg/shop.svg"} className="img-fluid abs-icon" alt="boxRemove" />
              </Link>
            </Col>
          </Row>
        </CardBody>
