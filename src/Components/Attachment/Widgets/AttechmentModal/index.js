...
const AttachmentModal = (props) => {
    ...
    const { data: attachmentsData, refetch } = useQuery([attachment], () => request({ url: attachment, params: {  search, sort: sorting, paginate: paginate, page ,...paramsProps } }), { enabled: false, refetchOnWindowFocus: false, select: (data) => data?.data });
