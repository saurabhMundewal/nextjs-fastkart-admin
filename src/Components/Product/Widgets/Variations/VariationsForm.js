...
const VariationsForm = ({
  ...
  useEffect(() => {
    setFieldValue(
      ...
      allPossibleCases(
        values["combination"]?.map((item) => item?.values?.map((elem) => elem))
      )[index]
    );
  ...
  useEffect(() => {
    ...
    values[`variations`][index]?.price,
    values[`variations`][index]?.discount,
  ]);


  useEffect(() => {    
    let variationImage = values[`variations`][index]?.images
    setFieldValue(`variations[${index}][imagesData]`, variationImage);
  }, [index]);
  return (
      ...
      {active === elem.id && (
        <div className="rule-edit-form">
          ...
          <FileUploadField
           ...
           uniquename={values[`variations`][index][`variation_image_details`]}
            type="file"
            values={values}
          ...
          {values.product_type == "digital" ? (
            <>
              ...
              />
              <CheckBoxField
                name={`variations[${index}][is_licensable]`}
                title="Licensable"
              />
              {values["variations"][index]["is_licensable"] ? (
                <>
