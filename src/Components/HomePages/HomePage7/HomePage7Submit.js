...
const HomePage7Submit = (values, mutate) => {
    ...
    if (values['homeBanner7Image']) {
        values['content']['home_banner']['main_banner']['image_url'] = values['homeBanner7Image'].original_url
    ...
    if (values['coupons']) {
        values['content']['coupons']['image_url'] = values['coupons']?.original_url
    ...
    if (values['sliderBanner']) {
        values['content']['slider_product_with_banner']['left_side_banners']['banner_1']['image_url'] = values['sliderBanner'].original_url
