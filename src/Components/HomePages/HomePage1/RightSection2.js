...
const RightSection2 = ({ values, setFieldValue, active, setActive, categoryData }) => {
        ...
        <div className='shipping-accordion-custom'>
            ...
            {active == 2 && (
                <div className="rule-edit-form">
                    ...
                    />
                      <MultiSelectField values={values} setFieldValue={setFieldValue} name='mainRightCategory' title="Category" data={categoryData} />
