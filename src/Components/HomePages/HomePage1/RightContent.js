...
import RightSection12 from './RightSection12'
...
const RightContent = ({ values, setFieldValue, productData, categoryData, setSearch ,storeData ,setStoreSearch }) => {
    ...
    return (
        <>
            ...
            <RightSection2 values={values} setFieldValue={setFieldValue} active={active} setActive={setActive}  categoryData={categoryData} />
            ...
            <RightSection12 values={values} setFieldValue={setFieldValue} active={active} setActive={setActive} productData={productData} setSearch={setSearch} />
                     <RightSection13 values={values} setFieldValue={setFieldValue} active={active} setActive={setActive} productData={productData} setSearch={setSearch} />
