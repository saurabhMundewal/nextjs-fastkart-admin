            ...
            <Formik
                ...
                {({ values, handleSubmit, setFieldValue }) => (
                    <>
                        ...
                        <Col sm="12">
                            <UserTransationsTable url={VendorTransations} moduleName="UserTransactions" setFieldValue={setFieldValue} values={values} ref={refRefetch} dateRange={true}  userIdParams={true}  paramsProps={{ vendor_id: values["vendor_id"] ? values["vendor_id"] : null }} />
                        </Col>
                    </>
                )}
            </Formik>
