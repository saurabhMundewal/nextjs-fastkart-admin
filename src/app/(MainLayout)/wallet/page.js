            ...
            <Formik
                ...
                {({ values, handleSubmit, setFieldValue }) => (
                    <>
                        ...
                        <Col sm="12">
                             < UserTransationsTable url={UserTransations} moduleName="UserTransactions" setFieldValue={setFieldValue}  userIdParams={true} ref={refRefetch} dateRange={true} paramsProps={{ consumer_id: values["consumer_id"] ? values["consumer_id"] : null }} />
                        </Col>
                    </>
                )}
            </Formik>
