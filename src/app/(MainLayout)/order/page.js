...
const Order = () => {
  const { data: StatisticsCountData, refetch, isLoading, } = useQuery([StatisticsCountAPI], () => request({ url: StatisticsCountAPI }), { refetchOnWindowFocus: false, select: (data) => data?.data });
